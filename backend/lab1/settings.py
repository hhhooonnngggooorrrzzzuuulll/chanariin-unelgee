...
SECRET_KEY = 'django-insecure-usu)rzkp^twumjvhap%gw4=2x&yx!zr=ofo&7fdih(_f^+1&qo'
...
# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, 'static'),  # Directory for project-wide static files
# ]
...
# Use this setting to allow specific origins
